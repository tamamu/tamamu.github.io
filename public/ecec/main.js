...
var _tamamu$ecec$LispHighlight$tokenToHtml = function (token) {
	var pre = {ctor: '_Tuple2', _0: 'white-space', _1: 'pre'};
	var display = {ctor: '_Tuple2', _0: 'display', _1: 'inline'};
	var _p0 = token;
	switch (_p0.ctor) {
		case 'Space':
			return A2(
...
var _tamamu$ecec$LispHighlight$parseNumber5 = _elm_tools$parser$Parser$source(
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		A2(
			_elm_tools$parser$Parser$ignore,
...
var _tamamu$ecec$LispHighlight$parseNumber4 = _elm_tools$parser$Parser$source(
	A2(_elm_tools$parser$Parser$ignore, _elm_tools$parser$Parser$oneOrMore, _elm_lang$core$Char$isDigit));
var _tamamu$ecec$LispHighlight$parseNumber3 = _elm_tools$parser$Parser$source(
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		A2(
			_elm_tools$parser$Parser_ops['|.'],
...
var _tamamu$ecec$LispHighlight$parseNumber2 = _elm_tools$parser$Parser$source(
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		A2(
			_elm_tools$parser$Parser_ops['|.'],
		...
		A2(_elm_tools$parser$Parser$ignore, _elm_tools$parser$Parser$oneOrMore, _elm_lang$core$Char$isDigit)));
var _tamamu$ecec$LispHighlight$parseNumber1 = _elm_tools$parser$Parser$source(
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		A2(
			_elm_tools$parser$Parser_ops['|.'],
		...
		A2(_elm_tools$parser$Parser$ignore, _elm_tools$parser$Parser$oneOrMore, _elm_lang$core$Char$isDigit)));
var _tamamu$ecec$LispHighlight$parseEscapedChar = _elm_tools$parser$Parser$source(
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		A2(
			_elm_tools$parser$Parser$ignore,
...
var _tamamu$ecec$LispHighlight$parseExceptDoubleQuote = A2(
...
var _tamamu$ecec$LispHighlight$parseStringChar = _elm_tools$parser$Parser$oneOf(
	{
		ctor: '::',
		_0: _tamamu$ecec$LispHighlight$parseEscapedChar,
		_1: {
			ctor: '::',
			_0: _tamamu$ecec$LispHighlight$parseExceptDoubleQuote,
			_1: {ctor: '[]'}
		}
	});
var _tamamu$ecec$LispHighlight$exceptDelim = function (c) {
	return !A2(
		_elm_lang$core$String$contains,
		_elm_lang$core$String$fromChar(c),
		'(), \t\n\':;');
};
var _tamamu$ecec$LispHighlight$symbolChar = function (c) {
	return A2(
		_elm_lang$core$String$contains,
		_elm_lang$core$String$fromChar(c),
		'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890!#$%&@^|/:[]{}?-=_*+.');
};
var _tamamu$ecec$LispHighlight$Other = function (a) {
	return {ctor: 'Other', _0: a};
};
var _tamamu$ecec$LispHighlight$Keyword = function (a) {
	return {ctor: 'Keyword', _0: a};
};
var _tamamu$ecec$LispHighlight$parseKeyword = A2(
	_elm_tools$parser$Parser_ops['|='],
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		_elm_tools$parser$Parser$succeed(_tamamu$ecec$LispHighlight$Keyword),
		_elm_tools$parser$Parser$symbol(':')),
	A2(_elm_tools$parser$Parser$keep, _elm_tools$parser$Parser$oneOrMore, _tamamu$ecec$LispHighlight$exceptDelim));
var _tamamu$ecec$LispHighlight$String = function (a) {
	return {ctor: 'String', _0: a};
};
var _tamamu$ecec$LispHighlight$parseString = A2(
	_elm_tools$parser$Parser_ops['|.'],
	A2(
		_elm_tools$parser$Parser_ops['|='],
		A2(
			_elm_tools$parser$Parser_ops['|.'],
			_elm_tools$parser$Parser$succeed(_tamamu$ecec$LispHighlight$String),
			_elm_tools$parser$Parser$symbol('\"')),
		A2(
			_elm_tools$parser$Parser$map,
			_elm_lang$core$String$concat,
			A2(_elm_tools$parser$Parser$repeat, _elm_tools$parser$Parser$zeroOrMore, _tamamu$ecec$LispHighlight$parseStringChar))),
	_elm_tools$parser$Parser$symbol('\"'));
var _tamamu$ecec$LispHighlight$Number = function (a) {
	return {ctor: 'Number', _0: a};
};
var _tamamu$ecec$LispHighlight$parseNumber = A2(
	_elm_tools$parser$Parser$map,
	_tamamu$ecec$LispHighlight$Number,
	_elm_tools$parser$Parser$oneOf(
		{
			ctor: '::',
			_0: _tamamu$ecec$LispHighlight$parseNumber1,
			_1: {
				ctor: '::',
				_0: _tamamu$ecec$LispHighlight$parseNumber2,
				_1: {
					ctor: '::',
					_0: _tamamu$ecec$LispHighlight$parseNumber3,
					_1: {
						ctor: '::',
						_0: _tamamu$ecec$LispHighlight$parseNumber4,
						_1: {
							ctor: '::',
							_0: _tamamu$ecec$LispHighlight$parseNumber5,
							_1: {ctor: '[]'}
						}
					}
				}
...
var _tamamu$ecec$LispHighlight$Symbol = function (a) {
	return {ctor: 'Symbol', _0: a};
};
var _tamamu$ecec$LispHighlight$parseSymbol = A2(
	_elm_tools$parser$Parser_ops['|='],
	_elm_tools$parser$Parser$succeed(_tamamu$ecec$LispHighlight$Symbol),
	A2(_elm_tools$parser$Parser$keep, _elm_tools$parser$Parser$oneOrMore, _tamamu$ecec$LispHighlight$symbolChar));
var _tamamu$ecec$LispHighlight$RightParen = {ctor: 'RightParen'};
var _tamamu$ecec$LispHighlight$LeftParen = {ctor: 'LeftParen'};
var _tamamu$ecec$LispHighlight$Space = function (a) {
	return {ctor: 'Space', _0: a};
};
var _tamamu$ecec$LispHighlight$tokenize = _elm_tools$parser$Parser$oneOf(
	{
		ctor: '::',
		_0: A2(
			_elm_tools$parser$Parser_ops['|='],
			_elm_tools$parser$Parser$succeed(_tamamu$ecec$LispHighlight$Space),
			A2(
				_elm_tools$parser$Parser$keep,
		...
		_1: {
			...
			_0: A2(
				_elm_tools$parser$Parser_ops['|.'],
				_elm_tools$parser$Parser$succeed(_tamamu$ecec$LispHighlight$LeftParen),
				_elm_tools$parser$Parser$symbol('(')),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_tools$parser$Parser_ops['|.'],
					_elm_tools$parser$Parser$succeed(_tamamu$ecec$LispHighlight$RightParen),
					_elm_tools$parser$Parser$symbol(')')),
				_1: {
					ctor: '::',
					_0: _tamamu$ecec$LispHighlight$parseString,
					_1: {
						ctor: '::',
						_0: _tamamu$ecec$LispHighlight$parseKeyword,
						_1: {
							ctor: '::',
							_0: _tamamu$ecec$LispHighlight$parseNumber,
							_1: {
								ctor: '::',
								_0: _tamamu$ecec$LispHighlight$parseSymbol,
								_1: {
									ctor: '::',
									_0: A2(
										_elm_tools$parser$Parser_ops['|='],
										_elm_tools$parser$Parser$succeed(_tamamu$ecec$LispHighlight$Other),
										A2(
											_elm_tools$parser$Parser$keep,
											_elm_tools$parser$Parser$oneOrMore,
											function (c) {
...
var _tamamu$ecec$LispHighlight$tokenizeSequence = A2(_elm_tools$parser$Parser$repeat, _elm_tools$parser$Parser$zeroOrMore, _tamamu$ecec$LispHighlight$tokenize);
var _tamamu$ecec$LispHighlight$highlight = function (src) {
	var result = A2(_elm_tools$parser$Parser$run, _tamamu$ecec$LispHighlight$tokenizeSequence, src);
	var _p1 = result;
	if (_p1.ctor === 'Ok') {
		return A2(
			_elm_lang$html$Html$span,
			{ctor: '[]'},
			A2(_elm_lang$core$List$map, _tamamu$ecec$LispHighlight$tokenToHtml, _p1._0));
	} else {
		return A2(
			_elm_lang$html$Html$span,
			{
...
var _tamamu$ecec$Main$updateContent = F3(
	function (src, row, fun) {
		return A2(
			_elm_lang$core$List$map,
			function (t) {
				var _p0 = t;
				var i = _p0._0;
				var s = _p0._1;
				return _elm_lang$core$Native_Utils.eq(i, row) ? fun(s) : s;
			},
			A2(
				_elm_lang$core$List$indexedMap,
				F2(
...
var _tamamu$ecec$Main$stringReplace = F4(
...
var _tamamu$ecec$Main$charsLength = function (string) {
	return _elm_lang$core$List$length(
		_elm_community$string_extra$String_Extra$toCodePoints(string));
};
var _tamamu$ecec$Main$moveCaretDown = F2(
	function (pos, max) {
		return _elm_lang$core$Native_Utils.update(
			pos,
			{
				row: A2(_elm_lang$core$Basics$min, max, pos.row + 1)
			});
	});
var _tamamu$ecec$Main$moveCaretUp = function (pos) {
	return _elm_lang$core$Native_Utils.update(
		pos,
		{
			row: A2(_elm_lang$core$Basics$max, 0, pos.row - 1)
		});
};
var _tamamu$ecec$Main$moveCaretRight = F2(
	function (pos, max) {
		return _elm_lang$core$Native_Utils.update(
			pos,
			{
				col: A2(_elm_lang$core$Basics$min, max, pos.col + 1)
			});
	});
var _tamamu$ecec$Main$moveCaretLeft = function (pos) {
	return _elm_lang$core$Native_Utils.update(
		pos,
		{
			col: A2(_elm_lang$core$Basics$max, 0, pos.col - 1)
		});
};
var _tamamu$ecec$Main$model = {
	id: 'editor',
	isFocused: false,
	content: {
		ctor: '::',
...
var _tamamu$ecec$Main$onChange = function (handler) {
...
var _tamamu$ecec$Main$onInput = function (handler) {
	var eventOptions = {stopPropagation: true, preventDefault: true};
	return A3(
		_rtfeldman$elm_css$Html_Styled_Events$onWithOptions,
		'input',
...
var _tamamu$ecec$Main$onPaste = function (handler) {
	var eventOptions = {stopPropagation: true, preventDefault: true};
	return A3(
		_rtfeldman$elm_css$Html_Styled_Events$onWithOptions,
		'paste',
...
var _tamamu$ecec$Main$shiftKey = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'shiftKey',
	...
	_elm_lang$core$Json_Decode$bool);
var _tamamu$ecec$Main$decodedKey = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'key',
	...
	_elm_lang$core$Json_Decode$string);
var _tamamu$ecec$Main$onKeyUp = function (handler) {
	var eventOptions = {stopPropagation: true, preventDefault: true};
	return A3(
		_rtfeldman$elm_css$Html_Styled_Events$onWithOptions,
		'keyup',
		eventOptions,
		A2(_elm_lang$core$Json_Decode$map, handler, _tamamu$ecec$Main$decodedKey));
};
var _tamamu$ecec$Main$onKeyDown = function (handler) {
	var eventOptions = {stopPropagation: true, preventDefault: true};
	return A3(
		_rtfeldman$elm_css$Html_Styled_Events$onWithOptions,
		'keydown',
		eventOptions,
		A3(_elm_lang$core$Json_Decode$map2, handler, _tamamu$ecec$Main$decodedKey, _tamamu$ecec$Main$shiftKey));
};
var _tamamu$ecec$Main$compositionData = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'data',
	...
	_elm_lang$core$Json_Decode$string);
var _tamamu$ecec$Main$onCompositionEnd = function (handler) {
	var eventOptions = {stopPropagation: true, preventDefault: true};
	return A3(
		_rtfeldman$elm_css$Html_Styled_Events$onWithOptions,
		'compositionend',
		eventOptions,
		A2(_elm_lang$core$Json_Decode$map, handler, _tamamu$ecec$Main$compositionData));
};
var _tamamu$ecec$Main$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {id: a, isFocused: b, content: c, lastKey: d, caretPos: e, isSelected: f, rangeFrom: g};
	});
var _tamamu$ecec$Main$CaretPosition = F2(
	function (a, b) {
		return {col: a, row: b};
	});
var _tamamu$ecec$Main$MoveDown = {ctor: 'MoveDown'};
var _tamamu$ecec$Main$MoveUp = {ctor: 'MoveUp'};
var _tamamu$ecec$Main$MoveRight = {ctor: 'MoveRight'};
var _tamamu$ecec$Main$MoveLeft = {ctor: 'MoveLeft'};
var _tamamu$ecec$Main$KeyUp = function (a) {
	return {ctor: 'KeyUp', _0: a};
};
var _tamamu$ecec$Main$KeyDown = F2(
	function (a, b) {
		return {ctor: 'KeyDown', _0: a, _1: b};
	});
var _tamamu$ecec$Main$NewLine = {ctor: 'NewLine'};
var _tamamu$ecec$Main$SetText = function (a) {
	return {ctor: 'SetText', _0: a};
};
var _tamamu$ecec$Main$Backspace = {ctor: 'Backspace'};
var _tamamu$ecec$Main$Insert = function (a) {
	return {ctor: 'Insert', _0: a};
};
var _tamamu$ecec$Main$Blured = {ctor: 'Blured'};
var _tamamu$ecec$Main$Focused = {ctor: 'Focused'};
var _tamamu$ecec$Main$FocusResult = function (a) {
	return {ctor: 'FocusResult', _0: a};
};
var _tamamu$ecec$Main$update = F2(
	function (msg, model) {
		update:
		while (true) {
			var caretPos = model.caretPos;
			var _p1 = msg;
			switch (_p1.ctor) {
				case 'FocusOn':
					return A2(
						...
						model,
						{
							...
							_0: A2(
								...
								_tamamu$ecec$Main$FocusResult,
								_elm_lang$dom$Dom$focus(_p1._0)),
							_1: {ctor: '[]'}
						});
				case 'FocusResult':
					var _p2 = _p1._0;
				...
				case 'Insert':
					var _p3 = _p1._0;
					if (model.isSelected) {
						var rangeRight = A2(_elm_lang$core$Basics$max, model.rangeFrom, model.caretPos.col);
						var rangeLeft = A2(_elm_lang$core$Basics$min, model.rangeFrom, model.caretPos.col);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{
									content: A3(
										_tamamu$ecec$Main$updateContent,
										model.content,
										caretPos.row,
										A3(_tamamu$ecec$Main$stringReplace, _p3, rangeLeft, rangeRight)),
									caretPos: _elm_lang$core$Native_Utils.update(
										caretPos,
										{col: rangeLeft}),
									isSelected: false
								}),
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									content: A3(
										...
										model.content,
										caretPos.row,
										A3(_tamamu$ecec$Main$stringReplace, _p3, model.caretPos.col, model.caretPos.col)),
									caretPos: _elm_lang$core$Native_Utils.update(
										caretPos,
										{
											col: model.caretPos.col + _tamamu$ecec$Main$charsLength(_p3)
										})
								}),
							{ctor: '[]'});
					}
				case 'Backspace':
					if (_elm_lang$core$Native_Utils.eq(model.caretPos.col, 0) && (_elm_lang$core$Native_Utils.cmp(model.caretPos.row, 0) > 0)) {
						var bottom = A2(_elm_lang$core$List$drop, model.caretPos.row + 1, model.content);
						var top = A2(_elm_lang$core$List$take, model.caretPos.row - 1, model.content);
						var currentLine = _elm_community$string_extra$String_Extra$toCodePoints(
							A2(
								_elm_lang$core$Maybe$withDefault,
								'',
								A2(_elm_community$list_extra$List_Extra$getAt, model.caretPos.row, model.content)));
						var right = A2(_elm_lang$core$List$drop, model.caretPos.col, currentLine);
						var prevLine = _elm_community$string_extra$String_Extra$toCodePoints(
							A2(
								_elm_lang$core$Maybe$withDefault,
								'',
								A2(_elm_community$list_extra$List_Extra$getAt, model.caretPos.row - 1, model.content)));
						var line = _elm_lang$core$List$concat(
							{
								ctor: '::',
								_0: prevLine,
								_1: {
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									content: _elm_lang$core$List$concat(
										{
											...
											_1: {
												...
												_0: {
													ctor: '::',
													_0: _elm_community$string_extra$String_Extra$fromCodePoints(line),
													_1: {ctor: '[]'}
												},
												_1: {
													ctor: '::',
									...
									caretPos: _elm_lang$core$Native_Utils.update(
										caretPos,
										{
											col: _elm_lang$core$List$length(line),
											row: model.caretPos.row - 1
										})
								}),
							{ctor: '[]'});
					} else {
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									content: A3(
										...
										model.content,
										caretPos.row,
										A3(_tamamu$ecec$Main$stringReplace, '', model.caretPos.col - 1, model.caretPos.col)),
									caretPos: _tamamu$ecec$Main$moveCaretLeft(model.caretPos)
								}),
							{ctor: '[]'});
					}
				case 'SetText':
				...
				case 'NewLine':
					var bottom = A2(_elm_lang$core$List$drop, model.caretPos.row + 1, model.content);
					var top = A2(_elm_lang$core$List$take, model.caretPos.row, model.content);
					var currentLine = _elm_community$string_extra$String_Extra$toCodePoints(
						A2(
							_elm_lang$core$Maybe$withDefault,
							'',
							A2(_elm_community$list_extra$List_Extra$getAt, model.caretPos.row, model.content)));
					var left = _elm_community$string_extra$String_Extra$fromCodePoints(
						A2(_elm_lang$core$List$take, model.caretPos.col, currentLine));
					var right = _elm_community$string_extra$String_Extra$fromCodePoints(
						A2(_elm_lang$core$List$drop, model.caretPos.col, currentLine));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{
								...
								caretPos: _elm_lang$core$Native_Utils.update(
									caretPos,
									{col: 0, row: model.caretPos.row + 1})
							}),
						{ctor: '[]'});
				case 'MoveLeft':
					var currentLine = _elm_community$string_extra$String_Extra$toCodePoints(
						A2(
							...
							'',
							A2(_elm_community$list_extra$List_Extra$getAt, model.caretPos.row, model.content)));
					var caretPos = _tamamu$ecec$Main$moveCaretLeft(
						{
							row: model.caretPos.row,
							col: A2(
								_elm_lang$core$Basics$min,
								model.caretPos.col,
								_elm_lang$core$List$length(currentLine))
						});
					var rangeLength = _elm_lang$core$Basics$abs(caretPos.col - model.rangeFrom);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
				...
				case 'MoveRight':
					var caretPos = A2(
						_tamamu$ecec$Main$moveCaretRight,
						model.caretPos,
						_tamamu$ecec$Main$charsLength(
							A2(
								_elm_lang$core$Maybe$withDefault,
								'',
								A2(_elm_community$list_extra$List_Extra$getAt, model.caretPos.row, model.content))));
					...
					return A2(
						...
						{ctor: '[]'});
				case 'MoveUp':
					var caretPos = _tamamu$ecec$Main$moveCaretUp(model.caretPos);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{caretPos: caretPos, isSelected: model.isSelected}),
						{ctor: '[]'});
				case 'MoveDown':
					var caretPos = A2(
						_tamamu$ecec$Main$moveCaretDown,
						model.caretPos,
						_elm_lang$core$List$length(model.content) - 1);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
				...
				case 'KeyDown':
					...
					switch (_p4) {
						case 'Backspace':
							if (model.isSelected) {
								var _v3 = _tamamu$ecec$Main$Insert(''),
								...
								var _v5 = _tamamu$ecec$Main$Backspace,
						...
						case 'Shift':
							return A2(
								...
								{ctor: '[]'});
						case 'Enter':
							var _v7 = _tamamu$ecec$Main$NewLine,
								_v8 = model;
							msg = _v7;
							model = _v8;
							continue update;
						...
						case 'NonConvert':
							return A2(
								...
								{ctor: '[]'});
						case 'ArrowLeft':
							var rangeLength = _elm_lang$core$Basics$abs(model.rangeFrom - model.caretPos.col);
							if (_p6) {
								if (model.isSelected) {
									var _v9 = _tamamu$ecec$Main$MoveLeft,
										_v10 = model;
									msg = _v9;
									model = _v10;
									continue update;
								} else {
									var _v11 = _tamamu$ecec$Main$MoveLeft,
										_v12 = _elm_lang$core$Native_Utils.update(
										model,
										{isSelected: true, rangeFrom: model.caretPos.col});
									msg = _v11;
									model = _v12;
									continue update;
								}
								...
								if (model.isSelected) {
									var _v13 = _tamamu$ecec$Main$MoveLeft,
										...
										model,
										{
											...
											caretPos: _elm_lang$core$Native_Utils.update(
												caretPos,
												{
													col: A2(_elm_lang$core$Basics$min, model.rangeFrom, model.caretPos.col) + 1
												})
										});
									msg = _v13;
									model = _v14;
									...
									var _v15 = _tamamu$ecec$Main$MoveLeft,
										_v16 = model;
									msg = _v15;
									model = _v16;
									continue update;
						...
						case 'ArrowRight':
							...
							if (_p6) {
								if (model.isSelected) {
									var _v17 = _tamamu$ecec$Main$MoveRight,
										_v18 = model;
									msg = _v17;
									model = _v18;
									continue update;
								} else {
									var _v19 = _tamamu$ecec$Main$MoveRight,
								...
								if (model.isSelected) {
									var _v21 = _tamamu$ecec$Main$MoveRight,
										...
										model,
										{
											...
											caretPos: _elm_lang$core$Native_Utils.update(
												caretPos,
												{
													col: A2(_elm_lang$core$Basics$max, model.rangeFrom, model.caretPos.col) - 1
												})
										});
									msg = _v21;
									model = _v22;
									...
									var _v23 = _tamamu$ecec$Main$MoveRight,
										_v24 = model;
									msg = _v23;
									model = _v24;
									continue update;
						...
						case 'ArrowUp':
							var _v25 = _tamamu$ecec$Main$MoveUp,
								_v26 = model;
							msg = _v25;
							model = _v26;
							continue update;
						case 'ArrowDown':
							var _v27 = _tamamu$ecec$Main$MoveDown,
								_v28 = model;
							msg = _v27;
							model = _v28;
							continue update;
						default:
							if (_elm_lang$core$Native_Utils.eq(
								...
								1)) {
								var _v29 = _tamamu$ecec$Main$Insert(_p5),
									_v30 = model;
								msg = _v29;
								model = _v30;
								continue update;
...
var _tamamu$ecec$Main$FocusOn = function (a) {
	return {ctor: 'FocusOn', _0: a};
};
var _tamamu$ecec$Main$view = function (model) {
	var rangeLength = _elm_lang$core$Basics$abs(model.rangeFrom - model.caretPos.col);
	var rangeLeft = A2(_elm_lang$core$Basics$min, model.rangeFrom, model.caretPos.col);
	var currentLine = A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		A2(_elm_community$list_extra$List_Extra$getAt, model.caretPos.row, model.content));
	var codePoints = _elm_community$string_extra$String_Extra$toCodePoints(currentLine);
	var caretText = _elm_community$string_extra$String_Extra$fromCodePoints(
		A2(_elm_lang$core$List$take, model.caretPos.col, codePoints));
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _tamamu$ecec$Main$onPaste(_tamamu$ecec$Main$Insert),
					_1: {
						ctor: '::',
						_0: _tamamu$ecec$Main$onKeyDown(_tamamu$ecec$Main$KeyDown),
						_1: {
							ctor: '::',
							_0: _tamamu$ecec$Main$onCompositionEnd(_tamamu$ecec$Main$Insert),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Events$onFocus(_tamamu$ecec$Main$Focused),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Events$onBlur(_tamamu$ecec$Main$Blured),
									_1: {
										ctor: '::',
																					...
																					_1: {
																						...
																						_1: {
																							...
																							_0: _rtfeldman$elm_css$Css$top(
																								_rtfeldman$elm_css$Css$em(
																									_elm_lang$core$Basics$toFloat(model.caretPos.row))),
																							_1: {
																								ctor: '::',
																								_0: _rtfeldman$elm_css$Css$left(
																									_rtfeldman$elm_css$Css$em(
																										_elm_lang$core$Basics$toFloat(model.caretPos.col))),
																								_1: {ctor: '[]'}
																							}
																						}
																					}
						...
						_0: A2(
								...
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$borderRight(
													_rtfeldman$elm_css$Css$px(0)),
												_1: {
													ctor: '::',
							...
							A2(
								...
								A2(
									_elm_lang$core$List$range,
									1,
									_elm_lang$core$List$length(model.content)))),
						_1: {
							ctor: '::',
							_0: A2(
								_rtfeldman$elm_css$Html_Styled$div,
								{
									...
									_1: {
										...
										_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(
											_tamamu$ecec$Main$FocusOn(model.id)),
										_1: {ctor: '[]'}
									}
								},
								{
														...
														return A2(
															...
															},
															{
																...
																_0: _rtfeldman$elm_css$Html_Styled$fromUnstyled(
																	_tamamu$ecec$LispHighlight$highlight(s)),
																_1: {ctor: '[]'}
															});
													},
													model.content)),
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled$text(
								_elm_lang$core$Basics$toString(model.caretPos)),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _tamamu$ecec$Main$main = _elm_lang$html$Html$program(
	{
		view: function (_p7) {
			return _rtfeldman$elm_css$Html_Styled$toUnstyled(
				_tamamu$ecec$Main$view(_p7));
		},
		update: _tamamu$ecec$Main$update,
		subscriptions: function (_p8) {
			return _elm_lang$core$Platform_Sub$none;
		},
		init: {ctor: '_Tuple2', _0: _tamamu$ecec$Main$model, _1: _elm_lang$core$Platform_Cmd$none}
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _tamamu$ecec$Main$main !== 'undefined') {
    _tamamu$ecec$Main$main(Elm['Main'], 'Main', undefined);
}
